...
export default function Buyone() {
     ...
     console.log("cobtext",contextstate);
     const check=isNaN(qty)
     console.log("check",check);
     useEffect(()=>{
      axios.get(`http://localhost:3001/user/cartitem20/${id}/${qty}`,
      {
        headers:{
                       Authorization:userid?.token,
        }
      }).then((dta)=>{
              console.log("buyonee",dta.data.message[0])
              newbuy(dta.data.message[0])
            

            const cost1=(buy.price)*(id)
            newcost(cost1)
...
<div className="container mt-4 p-0 payment_2" >
  ...
  <div className="row px-md-4 px-2 pt-4" style={{marginTop:"-2100px"}}>
                ...
                <tr className="border-bottom">
                  ...
                  <td>
                    <div className="d-flex">
                      <p className="pe-3">
                        <span className="red"> ₹{buy.price}</span>
                      </p>
      ...
      
   {
    ...
    <div className="col-lg-4 payment-summary make">
      ...
      <div className="card px-md-3 px-2 pt-4">
        ...
        <div className="d-flex flex-column b-bottom">
          ...
          <div className="d-flex justify-content-between">
            ...
            <p>{((buy.price)*(id))-(discount?.dicount)}</p>
      ...
      <div className="card px-md-3 px-2 pt-4">
        ...
        <div className="d-flex flex-column b-bottom">
          ...
          <div className="d-flex justify-content-between">
            {" "}
            <small className="text-muted">Reduced Amount</small>
            <p>₹0</p>
          </div>
        </div>
      </div>
